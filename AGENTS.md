...
- **当前状态**：迭代 2 已完成（后端 Nest.js + PG + Redis + 词库 5500 + 网格生成服务端权威），迭代 3-4 已完成，迭代 5 详细设计已完成
...
| `doc/迭代4-详细设计.md` | 迭代4的用户认证(JWT)、闯关(关卡/目标/星级/进度)、图鉴雏形 | 改迭代4代码前必读 |
| `doc/迭代5-详细设计.md` | 迭代5的划词判定优化(WebSocket+内存索引)、Boss关(高目标)、6×6、第4-6章扩容 | 改迭代5代码前必读 |
